				 		...
				 		<div class="bloglist-sec">
				 			@if(count($posts)>0)
					 			...
					 			<div class="blogpost style2">
					 				<div class="blog-posthumb"> <a href="{{$post->url}}" title=""><img src="{{$post->image_url}}"  height="280" width="322" alt="" /></a> </div>
					 				<div class="blog-postdetail">
					 					...
					 					<a class="bbutton" href="{{$post->url}}" title="">Read More <i class="la la-long-arrow-right"></i></a>
					 				</div>
					 			</div>
					 			@endforeach
					 			{{$posts->links()}}
